     ...
     {userProfile&&(<div className="Homepage">
          <MDBRow>
            ...
            <MDBCol  lg="4" md="4" size="12" sm="4">
              ...
              <MDBCard>
              <MDBCardBody>
                <h6><i className="fas fa-briefcase mr-2"></i>{userProfile.website?userProfile.website:"exampleWebsite.com"}</h6>
                <h6><i className="fas fa-home mr-2"></i>{userProfile.city&&userProfile.city?userProfile.city:"Example City"}</h6>
                <h6><i className="fas fa-envelope mr-2"></i>{userProfile.email?userProfile.email:"example@testmail.com"}</h6>
                <h6><i className="fas fa-phone-alt mr-2"></i>{userProfile.mobile&&userProfile.mobile?userProfile.mobile:"999999999"}</h6>
