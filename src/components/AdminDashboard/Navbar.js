    ...
    <nav className='navbarSide' style={{ background: "white", color: "black",zIndex:2 }}>
      <ul className='navbarSide-nav'>
        ...
        <li className='navSide-item'>
          <Link to='/admin-dashboard' className='navSide-link p-2' >
        ...
        <li className='navSide-item'>
          <Link to="/admin-dashboard/show-users" className='navSide-link p-2'>
        ...
        <li className='navSide-item'>
          <Link to='/admin-dashboard/display-projects' className='navSide-link p-2'>
            <MDBIcon icon="user-circle fa-2x" />
            <span className='linkSide-text'>Project List</span>
          </Link>
        </li>

        <li className='navSide-item'>
          <Link to='/admin-dashboard/create-project' className='navSide-link p-2'>
